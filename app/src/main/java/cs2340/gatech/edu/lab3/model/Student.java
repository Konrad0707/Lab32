...
public class Student implements Parcelable {
    ...
    public void setClassStanding(ClassStanding c) {
        _classStanding = c;
    }
    ...
    public Student(String name, String major) {
        ...
        _major= major;
        _id = Student.Next_Id++;
        _classStanding = ClassStanding.FR;
    }

    public Student(String name, String major, ClassStanding c) {
        this(name, major);
        _classStanding = c;
    }
    /**
     ...
     */
    public Student() {
        this("enter new name" , "NA", ClassStanding.FR);
    }
     ...
     */
    @Override
    public String toString() { return _name + " " + _major + " " + _classStanding;}
